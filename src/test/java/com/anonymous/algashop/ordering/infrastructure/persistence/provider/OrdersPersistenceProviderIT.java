...
import com.anonymous.algashop.ordering.infrastructure.persistence.repository.OrderPersistenceEntityRepository;
...
class OrdersPersistenceProviderIT {
    ...
    @Test
    @Transactional(propagation = Propagation.NOT_SUPPORTED) // Disable transaction for this test, which is injected by default by @DataJpaTest
